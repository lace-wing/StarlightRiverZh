...
public class PatchStarlightPlayer : MethodEntry
{
    ...
    {
        QTTM("WARNING", "警告");
        QTTM(@"Starlight River has unique behavior for its bosses in Master Mode. This behavior is intended to be immensely difficult over anything else, and assumes a high amount of knowldge about " +
